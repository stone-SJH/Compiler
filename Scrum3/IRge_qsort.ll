...
define i32 @main() {
  ...
  store i32 10, i32* %b
  %1 = load i32** %K
  %2 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  ...
  store i32 2, i32* %6
  %7 = load i32** %K
  %8 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %9 = getelementptr inbounds i32* %8, i64 2
  store i32 4, i32* %9
  %10 = load i32** %K
  %11 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %12 = getelementptr inbounds i32* %11, i64 3
  store i32 6, i32* %12
  %13 = load i32** %K
  %14 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %15 = getelementptr inbounds i32* %14, i64 4
  store i32 1, i32* %15
  %16 = load i32** %K
  %17 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %18 = getelementptr inbounds i32* %17, i64 5
  store i32 3, i32* %18
  %19 = load i32** %K
  %20 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %21 = getelementptr inbounds i32* %20, i64 6
  store i32 9, i32* %21
  %22 = load i32** %K
  %23 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %24 = getelementptr inbounds i32* %23, i64 7
  store i32 1, i32* %24
  %25 = load i32** %K
  %26 = getelementptr inbounds[10 x i32]* %K, i32 0, i32 0
  %27 = getelementptr inbounds i32* %26, i64 8
  store i32 10, i32* %27
  %28 = load i32** %K
  ...
  %31 = load i32** %K
  %32 = load i32* %b
  call void @QuickSort(i32* %31, i32 %32)
